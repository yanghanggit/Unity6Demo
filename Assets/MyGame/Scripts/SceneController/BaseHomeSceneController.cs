...
/// 场景控制器基类，包含所有场景的共同逻辑
/// </summary>
public abstract class BaseHomeSceneController : MonoBehaviour
{
    // 公共字段
    public GameObject _backgroundImage;
    public SpriteRenderer _templateActor;
    public float _spacingOffset = 0.5f;
    ...
    public void OnClickSendMessage()
    {
        ...
        if (RootResp.Get() != null && !string.IsNullOrEmpty(_currentSpriteName) && !string.IsNullOrEmpty(_inputField.text))
        {
