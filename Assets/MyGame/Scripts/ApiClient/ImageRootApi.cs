...
/// <summary>
/// Image Root API 客户端，用于获取服务器根配置信息
/// </summary>
public class ImageRootApi : BaseApiClient
{
    /// <summary>
    /// 请求结果
    /// </summary>
    ...
    /// 响应数据
    /// </summary>
    private ImageRootResponse _responseData;
    ...
    public IEnumerator Call(string rootUrl)
    {
        ...
        try
        {
            _responseData = JsonConvert.DeserializeObject<ImageRootResponse>(_requestResult.responseText);
