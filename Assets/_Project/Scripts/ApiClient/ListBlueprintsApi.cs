...
/// </summary>
public class ListBlueprintsApi : BaseApiClient
{
    /// <summary>
    /// 请求结果
    /// </summary>
    ...
    /// 响应数据
    /// </summary>
    private BlueprintListResponse _responseData;

    /// <summary>
    /// 获取响应数据
    /// </summary>
    public BlueprintListResponse RespData => _responseData;
    ...
    public async UniTask Call(string url)
    {
        ...
        try
        {
            _responseData = JsonConvert.DeserializeObject<BlueprintListResponse>(_requestResult.responseText);
