...
/// <summary>
/// DungeonCombatInit API 客户端，用于处理地下城战斗初始化请求
/// </summary>
public class DungeonCombatInitApi : BaseApiClient
{
    /// <summary>
    /// 请求结果
    /// </summary>
    ...
    /// 响应数据
    /// </summary>
    private DungeonCombatInitResponse _responseData;

    /// <summary>
    /// 获取响应数据
    /// </summary>
    public DungeonCombatInitResponse RespData => _responseData;
    ...
    {
        // 记录请求信息
        Debug.Log("Starting DungeonCombatInitApi call...");
        Debug.Log($"URL: {url}");
        ...
        // 创建请求数据
        var requestData = new DungeonCombatInitRequest
        {
            user_name = userName,
            game_name = gameName,
        };
        ...
        try
        {
            _responseData = JsonConvert.DeserializeObject<DungeonCombatInitResponse>(_requestResult.responseText);
